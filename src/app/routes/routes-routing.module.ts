...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'tester-score', component: TesterScoreComponent },
      { path: 'register-subject', component: RegisterSubjectComponent },
      { path: 'add-score', component: AddScoreComponent },
      { path: 'examination-score', component: ExaminationScoreComponent },
