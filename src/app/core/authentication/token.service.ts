...
export class TokenService implements OnDestroy {
  ...
  private save(token?: Token): void {
    ...
    if (!token) {
      ...
      // token = {
      //   "access_token": 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjp7ImlkIjoxLCJ1c2VybmFtZSI6Im5nLW1hdGVybyIsIm5hbWUiOiJab25nYmluIiwiZW1haWwiOiJuemIzMjlAMTYzLmNvbSIsImF2YXRhciI6Ii4vYXNzZXRzL2ltYWdlcy9hdmF0YXIuanBnIn19.bmctbWF0ZXJv'
      //   ,"token_type": 'bearer'
      //   ,"expires_in": '20000'
      //   ,"exp": null
      //   , "refresh_token" : false};
      ...
      const value1 = {
        access_token:
          'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyIjp7ImlkIjoxLCJ1c2VybmFtZSI6Im5nLW1hdGVybyIsIm5hbWUiOiJab25nYmluIiwiZW1haWwiOiJuemIzMjlAMTYzLmNvbSIsImF2YXRhciI6Ii4vYXNzZXRzL2ltYWdlcy9hdmF0YXIuanBnIn19.bmctbWF0ZXJv',
        token_type: 'bearer',
        exp: null,
      };

      this.store.set(this.key, filterObject(value1));
    }
